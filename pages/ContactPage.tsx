...
import { ARTIST_CONTACT_EMAIL, ARTIST_CONTACT_PHONE, ARTIST_NAME, ARTIST_SOCIAL_LINKS } from '../constants';
  ...
  return (
    <div className="pt-24 pb-20 bg-secondary min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        <SectionTitle
          title="Get In Touch"
          subtitle="Have a question, commission request, or just want to say hello?"
        />

        <div className="bg-light p-8 md:p-12 rounded-lg shadow-xl text-dark text-center">
          <p className="text-lg mb-6">
            Feel free to reach out to {ARTIST_NAME} using the contact details below, or connect on social media.
          </p>

          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-4">Contact Information</h3>
            <p className="text-xl mb-2">
              Email: <a href={`mailto:${ARTIST_CONTACT_EMAIL}`} className="text-primary hover:underline transition-colors duration-300">{ARTIST_CONTACT_EMAIL}</a>
            </p>
            <p className="text-xl">
              Phone: <a href={`tel:${ARTIST_CONTACT_PHONE}`} className="text-primary hover:underline transition-colors duration-300">{ARTIST_CONTACT_PHONE}</a>
            </p>
          </div>
